...
function countDown() {
	...
	dia.innerHTML = formatoTempo(totalDias);
	hora.innerHTML = formatoTempo(totalHoras);
	minutos.innerHTML = formatoTempo(totalMinutos);
	segundos.innerHTML = formatoTempo(totalSegundos);
}
